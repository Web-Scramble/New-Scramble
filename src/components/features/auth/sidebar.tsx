            ...
            return (
              <div key={index} className="flex flex-col ">
                <div className={cn("flex items-start gap-3 text-gray-400", !isActive && "opacity-25")}>
                  ...
                  <div>
                    <p className={cn("font-bold text-left text-[#2154B2] text-xl font-grotesk",isActive &&" ")}>{step.label}</p>
                    <p className={cn("text-xs text-[#2154B2]/50 text-left font-medium",isActive &&"")}>{step.description}</p>
                  </div>
                </div>
              </div>
            );
